...
```bash
# make proposal
evmosd tx gov submit-proposal software-upgrade "v8.1.0" \
--title "Evmos Local v8.1.0 Upgrade" \
...
```bash
evmosd tx gov submit-proposal software-upgrade "v8.1.0" \
--title "Evmos Testnet v8.1.0 Upgrade" \
...
{
  "binaries":{
  "darwin/arm64":"https://github.com/tharsis/evmos/releases/download/v8.1.0/evmos_8.1.0_Darwin_arm64.tar.gz",
  "darwin/x86_64":"https://github.com/tharsis/evmos/releases/download/v8.1.0/evmos_8.1.0_Darwin_x86_64.tar.gz",
  "linux/arm64":"https://github.com/tharsis/evmos/releases/download/v8.1.0/evmos_8.1.0_Linux_arm64.tar.gz",
  "linux/x86_64":"https://github.com/tharsis/evmos/releases/download/v8.1.0/evmos_8.1.0_Linux_x86_64.tar.gz",
  "windows/x86_64":"https://github.com/tharsis/evmos/releases/download/v8.1.0/evmos_8.1.0_Windows_x86_64.zip"
  }
}
```